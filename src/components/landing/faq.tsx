...
const faqs = [
  {
    ...
    answer: "Completely free. No ads, no premium tiers, no paywalls. Recovery tools should be accessible to everyone."
  },
  {
    question: "How do I connect with my sponsor?",
    answer: "Your sponsor generates a unique 8-character invite code from their profile. Enter it in your app to connect instantly."
  },
  {
    question: "Is my data private?",
    answer: "Your sobriety data and personal notes are only visible to you and your connected sponsor. We use bank-level encryption and never share your information."
  },
  {
    question: "Can I be both a sponsor and a sponsee?",
    answer: "Absolutely. No role restrictions—you can guide others while receiving guidance yourself."
  },
  {
    question: "What happens if I relapse?",
    answer: "Recovery isn't a straight line. Document relapses honestly—your counter resets but your entire journey history is preserved. No shame, no judgment."
  },
  {
    question: "What 12-step programs does the app support?",
    answer: "All of them. AA, NA, CA, OA, GA—if it has 12 steps and accountability partners, we've got you covered."
  }
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-base md:text-lg font-medium text-foreground tracking-wide">{item.question}</span>
          <div className="flex-shrink-0 ml-4 w-6 h-6 flex items-center justify-center rounded-full bg-background border border-border">
            <motion.svg 
              ...
              width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-muted-foreground"
            >
