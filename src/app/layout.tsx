...
export const metadata: Metadata = {
  ...
  description:
    'Empowering 12-step recovery with structured accountability, precise sobriety tracking, and visual timelines for sponsors and sponsees.',
  ...
  openGraph: {
    title: 'Sobers — Recovery Redefined',
    description:
      'Empowering 12-step recovery with structured accountability, precise sobriety tracking, and visual timelines.',
