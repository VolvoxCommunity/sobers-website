  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="December 2025">
      <Section title="Introduction">
        <p>
          Sobers (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;), operated by Volvox, is
        ...
        <p className="p-6 bg-card border border-border rounded-2xl italic text-muted-foreground">
          &ldquo;We understand that recovery is a deeply personal journey. That&apos;s why
          we&apos;ve built Sobers with privacy as a foundational principle. Your sobriety data,
          personal reflections, and recovery progress are treated with the highest level of care and
          protection.&rdquo;
        </p>
      </Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <ul className="space-y-2 list-disc list-inside text-muted-foreground">
              <li>
                Email address{' '}
                <span className="text-[10px] bg-muted px-2 py-0.5 rounded uppercase">Required</span>
              </li>
        ...
        <div className="space-y-6">
          <div className="p-6 bg-card border border-border rounded-2xl transition-colors hover:bg-muted">
            ...
            <p className="text-sm text-muted-foreground">
              Stores your account data, recovery progress, tasks, and messages securely with
          ...
          <div className="p-6 bg-card border border-border rounded-2xl transition-colors hover:bg-muted">
            ...
            <p className="text-sm text-muted-foreground">
              Helps us identify and fix crashes. All sensitive data is automatically scrubbed before
              any report is sent.
            </p>
          </div>
        </div>
      ...
      <Section title="Data Sharing">
        ...
        <p>
          Your sobriety information, notes, and personal details are only shared with your connected
          sponsor or sponsee (milestones and tasks only) and trusted service providers.
        </p>
      </Section>
      ...
      <Section title="Data Retention">
        <div className="p-6 bg-destructive/5 border border-destructive/10 rounded-2xl">
          <p className="text-muted-foreground">
            ...
            all your personal data is <strong>permanently and irreversibly deleted</strong>.
          </p>
        </div>
      </Section>
